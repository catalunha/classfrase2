...
class PdfAllPage extends StatelessWidget {
  ...
  writePhraseList() {
    ...
    _phraseController.sortByFolder(_phraseController.isSortedByFolder.value);
      ...
      child: pw.Row(
        ...
        children: <pw.Widget>[
          pw.Column(
            crossAxisAlignment: pw.CrossAxisAlignment.start,
            children: [
              pw.Text(_splashController.userModel!.profile!.name ?? 'Sem nome'),
              pw.Text(
                  'Classificador destas ${_phraseController.phraseList.length} frases:'),
              // pw.Divider(),
            ],
          ),
          // image != null
